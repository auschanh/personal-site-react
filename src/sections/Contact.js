            ...
            >
              ...
              <div className="-mx-3 mb-6 flex flex-wrap">
                <div className="mb-6 w-full px-3 md:mb-0 md:w-1/2">
                  <label
                    className="mb-2 block text-xs font-bold uppercase tracking-wide text-gray-700 dark:text-teal-green"
                    htmlFor="name"
                  >
                    Your Name
                  </label>
              ...
              <div className="-mx-3 mb-6 flex flex-wrap">
                <div className="w-full px-3">
                  ...
                  <input
                    className="mb-3 block w-full appearance-none rounded border border-gray-200 bg-indigo-100 px-4 py-3 leading-tight text-black placeholder-gray-500 focus:border-gray-500 focus:bg-white focus:outline-none"
                    id="subject"
                    name="subject"
                    type="text"
              ...
              <div className="-mx-3 mb-6 flex flex-wrap">
                ...
                {isAlertOpen && (
                  <Alert className="mt-3 w-full justify-center bg-transparent">
                    <div className="flex items-center justify-center gap-2 rounded-2xl border bg-dark-navy px-8 py-2 text-center text-zinc-400">
                      <svg
