              ...
              <div>
                ...
                <div className='flex flex-col lg:flex-row items-center justify-center lg:items-start'>
                  ...
                  <div className='sm:ml-6 mt-4 sm:mt-0 dark:text-zinc-300'>
                    <a className="font-bold dark:text-teal-600 text-teal-300 dark:hover:text-gray-600 hover:text-gray-400 hover:underline hover:decoration-rose-600 hover:decoration-2 hover:underline-offset-[6px] font-mono" href={link} target="_blank"
